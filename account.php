 ...
 *
 * Shows the logged-in user's orders and event tickets.
 */
...
// Fetch user's merchandise orders
$orders = $db->query(
...
// Fetch user's event tickets with event details
$tickets = $db->query(
    ...
    <table class="table">
      ...
      <tbody>
        <?php while ($ticket = $tickets->fetch_assoc()) { ?>
          <tr>
            <td>
              <?php echo htmlspecialchars($ticket['title']); ?><br>
